...
from src.fasteval.functions import PlaceholderConstant
from src.fasteval.const import make_const_optimizer
from src.fasteval.utils import cached_property
import src.fasteval.utils as U
...
class Program(object):
    ...
    def set_execute(cls, protected):
        ...
        try:
            ...
            from src.fasteval.execute import python_execute
